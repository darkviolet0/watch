...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { long_description: @theme.long_description, name: @theme.name, short_description: @theme.short_description } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { long_description: @theme.long_description, name: @theme.name, short_description: @theme.short_description } }
